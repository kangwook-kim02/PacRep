...
The file ./data/preprocess.py processes three public datasets—ISCXVPN2016, USTCTFC2016, and DoHBrw2020—by dividing the traffic into flow-level units and constructing the corresponding train, test, and validation splits.

The files ./visualize/compare.py and ./visualize/confusion_matrix.py provide visualization utilities for presenting the experimental results.
